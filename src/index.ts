...
const selector =
  '#__next > main > div.bg-mtc-dark > div.pt-\\[4rem\\].sm\\:pt-0.dark > div.container.mx-auto.px-4.py-4.lg\\:py-10 > div > div.lg\\:w-2\\/6.order-1.lg\\:order-2 > div > div.space-y-4 > div > span.font-bold'
...
const embed = new EmbedBuilder()
  ...
  .addFields({
    name: '가격',
    value: `₩${(await getPrice()) || '오류가 발생했습니다!'}`,
    inline: true
  })
  .setColor('#447D9B')
  .setTimestamp()
